...
export class Projects {
    protected readonly icons: Readonly<Record<string, string>> = {
        ...
        Firebase:
            'M3.89 15.673L6.255.461A.542.542 0 0 1 7.27.288l2.543 4.771zm16.794 3.692l-2.25-13.94a.54.54 0 0 0-.919-.295L3.316 19.365l7.856 4.427a1.62 1.62 0 0 0 1.588 0zM14.3 7.147l-1.82-3.482a.542.542 0 0 0-.96 0L3.53 17.984z',
    };
    ...
    protected readonly projects = signal<readonly Project[]>([
        ...
        },
        {
            ...
            about: 'Short description of El Pollo Loco goes here.',
        ...
        },
        {
            ...
            about: 'Short description of DA Bubble goes here.',
    ...
    protected readonly openProject = computed(() => {
    ...
    protected next(): void {
        ...
        this.openIndex.set((index + 1) % this.projects().length);
    }
